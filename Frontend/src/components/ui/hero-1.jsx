...
export default function Hero1({
    ...
    const handleNavLinkClick = (clickedLink, e) => {
        ...
        <section
            ...
            {showHeader && (
                ...
                <a href="/" className="flex items-center gap-1 group">
                    {typeof brand === "string" ? (
                        <span
                            className="relative text-white font-semibold text-lg tracking-tight select-none">
                            {brand}
            ...
            <motion.div
                ...
                <div className="flex flex-col gap-8 md:gap-10 max-w-[850px] mt-[5vh]">
                    ...
                    <motion.div variants={itemVariants} className="w-fit">
                        <a
                            ...
                            <span>{ctaLabel}</span>
                            <span
                                className="w-8 h-8 rounded-md bg-black flex items-center justify-center shrink-0 overflow-hidden relative">
                                {/* Arrow up-right with custom sliding movement on hover */}
                                <ArrowUpRight
                                    className="w-4 h-4 text-white transition-transform duration-300 ease-out group-hover:translate-x-[2px] group-hover:translate-y-[-2px]" />
                            </span>
                        </a>
                    </motion.div>
                </div>
                ...
                <motion.div
                    ...
                    <div className="md:max-w-3xl">
                        <p
                            className="text-white text-base md:text-lg lg:text-xl leading-relaxed font-normal whitespace-pre-line">
                            {description}
                        </p>
                    </div>
                    ...
                    <div
                        className="flex flex-col md:flex-row md:items-end justify-between lg:justify-end gap-10 pb-1 w-full lg:w-auto">
                        ...
                        <div
                            className="hidden md:flex items-center gap-3 text-white text-sm lg:text-base tracking-wide order-2 lg:order-1 lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:bottom-1">
